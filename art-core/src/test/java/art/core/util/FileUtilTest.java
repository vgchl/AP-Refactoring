...
public class FileUtilTest {
    ...
    public void setUp() throws URISyntaxException {
        directory = new File(getClass().getResource("art/core/util/file_util/data").toURI());
        file = new File(getClass().getResource("art/core/util/file_util/data/file_1.txt").toURI());
