...
public class MagicLiteralSolver extends IssueSolver {
	...
	protected Solution internalSolve(Issue issue,
		...
		LiteralSolutiobBuilderFactory factory = new LiteralSolutiobBuilderFactory();

		LiteralSolutionBuilder solutionBuilder = factory.getSolutionBuilder(
				issue, this, parameters);
	...
	protected abstract class LiteralSolutionBuilder {
	...
	protected class NumberLiteralSolutionBuilder extends LiteralSolutionBuilder {

		public NumberLiteralSolutionBuilder(Issue issue,
				IssueSolver issueSolver, Map<String, Parameter> parameters) {
			super(issue, issueSolver, parameters);
		}

		@Override
		public Solution build() {

			String name = (String) parameters.get(PARAMETER_CONSTANT_NAME)
					.getValue();
	...
	private class StringLiteralSolutionBuilder extends LiteralSolutionBuilder {
	...
	private class LiteralSolutiobBuilderFactory {

		public LiteralSolutionBuilder getSolutionBuilder(Issue issue,
				IssueSolver issueSolver, Map<String, Parameter> parameters) {
