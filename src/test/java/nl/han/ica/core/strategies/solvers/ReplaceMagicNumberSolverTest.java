...
//
//    private MagicNumberSolver magicNumber;
//
//    @Before
...
//
//        magicNumber = new MagicNumberSolver(ruleViolation);
//        magicNumber.buildAST(file);
//    }
//
//    @Test
//    public void testRewriteAST() throws Exception {
//        //magicNumber.setReplaceName("MAGICINT");
//        magicNumber.rewriteAST();
//        Assert.assertEquals(magicNumber.getDocument().get(), rewrittenFile());
//
//    }
//
